...
public class CouponSelectingAdapter extends RecyclerView.Adapter<CouponSelectingAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public CouponSelectingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = null;
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.coupon_selecting_recycler_item_layout,parent,false);
        return new CouponSelectingAdapter.ViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull CouponSelectingAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (couponType.equalsIgnoreCase("ORDER")) {
            if (discountType.equalsIgnoreCase("PERCENTAGE") && minimumPurchaseType.equalsIgnoreCase("AMOUNT")) {
                ...
                if (finalAmount >= minimumPurchaseValue) {
                    ...
                    holder.text1.setTextColor(ContextCompat.getColor(context.getContext(),R.color.dark_grey));
                    holder.text2.setTextColor(ContextCompat.getColor(context.getContext(),R.color.dark_grey));
                    holder.couponTxt.setTextColor(ContextCompat.getColor(context.getContext(),R.color.dark_grey));
                    holder.tapToApply.setTextColor(ContextCompat.getColor(context.getContext(),R.color.dark_grey));
                }
