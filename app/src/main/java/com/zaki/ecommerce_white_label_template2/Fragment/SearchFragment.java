...
public class SearchFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        searchingRecycler.setLayoutManager(new GridLayoutManager(getContext(),2));
                            ...
                            if (!casualDressArrayList.isEmpty()) {
                                if (changingWishListIcon())
                                    if (productRecyclerForActivityAdapter == null) {
                                        productRecyclerForActivityAdapter = new ProductRecyclerForActivityAdapter(casualDressArrayList, getContext());
